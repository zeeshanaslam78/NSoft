...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private void createAddButton(Context context) {
    mAddButton = new AddFloatingActionButton(context) {
      ...
      Drawable getIconDrawable() {
        ...
        collapseAnimator.setInterpolator(linearInterpolator);
        expandAnimator.setInterpolator(linearInterpolator);
  ...
  private static Interpolator sExpandInterpolator = new LinearInterpolator();
